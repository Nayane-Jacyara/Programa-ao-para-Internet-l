...
function ResetSenha(){
  ...
  function recuperarSenha(){
    ...
    firebase.auth().sendPasswordResetEmail(email).then(resultado => {
      ...
      setSucesso('');
      setMensagem('Não existe esse e-mail em registo' );
    })
    ...
    return <div className="d-flex align-items-center text-center form-container">
      <form className="form-signin">
        <img className="mb-4" src="/Images/SisSac2.jpg" alt="" />
        ...
        <p className="mt-5 mb-3 text-muted">&copy; Desenvolvido por Nayene Jacyara e Iasabel Perreira</p>
      </form>
    </div>
  }
